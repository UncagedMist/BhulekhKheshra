    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        privacyShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String message = "Check all the details of your land records. Install Land Record App and Stay Updated! \n https://play.google.com/store/apps/details?id=tbc.uncagedmist.bhulekhkheshra";
                intent.putExtra(Intent.EXTRA_TEXT, message);
                startActivity(Intent.createChooser(intent, "Share Land Records App Using"));
            }
        });
